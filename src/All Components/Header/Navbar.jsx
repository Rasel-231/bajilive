...
// import brandLogo from "../../assets/brandImg/brandLogo.png";
...
//      <Link to='/promotions'><li><a>PROMOTIONS</a></li></Link> 
...
//           </ul>
//         </div>
//         <a className="btn btn-ghost text-md sm:text-xl"><img src={brandLogo} alt="404" className="sm:h-8 h-4"/>|| BAJILIVE</a>
//       </div>
...
//         {
//           user ? <button onClick={Logout} className="btn btn-outline flex gap-2">Logout<MdLogout className="mt-1 "/></button> :<Link to={"/login"}className="btn btn-outline"> LOGIN</Link>
//         }
    ...
    <div className="navbar fixed z-30 bg-opacity-20 bg-black text-white max-w-screen">
      <div className="navbar-start">
        ...
        <a className="btn btn-ghost text-md sm:text-xl">
          <img src={brandLogo} alt="404" className="sm:h-8 h-4" />|| BAJILIVE
        </a>
      </div>
      <div className="navbar-center hidden lg:flex">
        <ul className="menu menu-horizontal px-1">{Alllink}</ul>
