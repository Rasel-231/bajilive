...
import banner from "../../../assets/DownBanner/banner.jpg"
import mainBanner from "../../../assets/DownBanner/mainbanner.jpg"
const DownBanner = () => {
    return (
       <div className="text-white">
         <section className='bg-fixed  pt-8 my-20' style={{
            ...
            <div><img src={banner} alt="404" className='w-[100%] h-[300px] shadow-md rounded-md'/></div>
