    ...
    <div className="space-y-4 p-4 text-white font-bold shadow-sm">
      {users && users.length > 0 ? (
        users.map((user, index) => (
          <section className="p-4 border border-gray-300 opacity-80 shadow-md justify-center bg-no-repeat bg-cover bg-center rounded-lg" 
          style={{ backgroundImage: 'url(https://i.ibb.co.com/R40Ks2yG/maxresdefault.jpg)' }}>
            <p>SI:{index + 1}</p>
